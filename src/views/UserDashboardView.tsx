      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-2xl border border-outline-variant/30 shadow-xs">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            className="px-5 py-2.5 bg-primary hover:bg-primary-container text-white font-bold text-xs rounded-xl shadow-xs transition-colors flex items-center gap-1.5 cursor-pointer"
          >
                ...
                >
                  ...
                  <div className="flex items-center gap-2 pt-2 border-t border-gray-100">
                    <button
                      ...
                      className="flex-1 py-2 bg-white text-primary font-bold text-xs rounded-xl border border-primary/30 hover:bg-surface-container transition-colors cursor-pointer text-center"
                    >
                      View Details
                    </button>
                    <button
                      onClick={onOpenApplyModal}
                      className="flex-1 py-2 bg-primary hover:bg-primary-container text-white font-bold text-xs rounded-xl transition-colors cursor-pointer text-center shadow-xs"
                    >
                      Apply
                    </button>
                  </div>
